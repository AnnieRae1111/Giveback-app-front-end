...
const EditPost = ({items, handleEdit, editCategory, setEditCategory, editTitle, setEditTitle, editPhotoUrl, setEditPhotoUrl, editDescription, setEditDescription}) => {
    const { id } = useParams()
    ...
    }, [item, setEditCategory, setEditDescription, setEditTitle, setEditPhotoUrl ])
    ...
    return ( 
        <div className="upload-form-container">
            ...
            <Form id="upload-form" onSubmit={(event)=>event.preventDefault()}>
                ...
                <Button type="submit" onClick={()=> handleEdit(item._id)} id="submit-button">
                    Submit
                </Button>
            </Form>
            </>
