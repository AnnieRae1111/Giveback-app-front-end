        ...
        return (  
            ...
            <CardColumns>
                <Card className="available-items-card">
                    ...
                    {show && <EditPostModal  itemId={itemId} photoUrl={photoUrl} category={category} title={title} datePosted={date_posted} postedBy={postedBy} description={description} editTitle={editTitle} closeModal={handleClose}/>}
            </CardBody>
            </Card>
            </CardColumns>
            </Col>
